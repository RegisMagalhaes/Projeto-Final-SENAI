...
{
    public class AtualizarTurmaCommand : Notifiable<Notification>, ICommand
    {
        public AtualizarTurmaCommand()
        {

        }

        public AtualizarTurmaCommand(string nomeTurma, int capacidade, Guid idAluno, Aluno aluno)
        {
            NomeTurma = nomeTurma;
